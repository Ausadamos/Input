...
namespace InputManagement.Controllers
{
    public class InputOrderControllers
    {
        ...
        public DataTable SearchOrderInThisYear(string product)
        {
            ...
            try
            {
                OrderProperty dataItem = new OrderProperty { Sub_Product = new SubProductProperty { PRODUCT_SUB_NAME = product } };
        ...
        public DataTable SearchOrderAll(string product)
        {
            DataTable _result = new DataTable();
            try
            {
                ...
                _resultData = _models.SearchOrderAll(dataItem);
                if (_resultData.StatusOnDb == true)
                {
                    DataTable tableMain = _resultData.ResultOnDb;
                    _resultData = _models.GetOrderActualInput();
