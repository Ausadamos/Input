...
namespace Input
{
    public partial class pageInput_Main : UserControl
    {
        ...
        public List<OrderProperty> _listOrderInput;

        public pageInput_Main(frmMain obj)
        {
            InitializeComponent();
            _frmMain = obj;
        }
        private void pageInput_Main_Load(object sender, EventArgs e)
        {
        ...
        private void Load_PageSelectOrder()
        {
            ...
            pageInput_SelectOrder _pageOrder = new pageInput_SelectOrder(_frmMain);
            _frmMain.panBody.Controls.Add(_pageOrder);
        ...
        private void cmbSelect_PurchaseNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                string purchaseNo = this.cmbSelect_PurchaseNo.Text;
                foreach (PurchaseProperty _purchaseNo in _listPurchase)
                {
                    if (purchaseNo == _purchaseNo.PURCHASE_NO)
                    {
                        this.txtProductPurchase.Text = _purchaseNo.PRODUCT_PURCHASE.ToString();
                        this.txtFFTCode.Text = _purchaseNo.FFT_CODE.ToString();
                    }
        ...
        public void Load_PageInputConfirm()
        {
            ...
            //Load page Select order.
            pageInput_Confirm _pageinputConfirm = new pageInput_Confirm(this, _frmMain);
            _frmMain.panBody.Controls.Add(_pageinputConfirm);
            _pageinputConfirm.Dock = DockStyle.Fill;
            _pageinputConfirm.BringToFront();
        }
    }
}
